const architects = [
...

  {
    ...
    "placeOfBirth": "Масква",
    "bio": [
      {date: '1913 - 1918', text: 'Навучаўся ў МУЖВЗ (яго бацька быў настаяцелем суседняга храма), затым да 1924 года ва ВХУТЕМАСе'},
      {date: '1924', text: 'Працаваў у архітэктурна-праектных арганізацыях Масквы і адначасова выкладаў (1934-1941 гадах, з 1948 года-прафесар) У МАРХІ .'},
    ...
    "project": [
      ...
      {date: '1923', text: 'Павільён машынабудавання і аўдыторыя на Усерасійскай сельскагаспадарчай і саматужна-прамысловай выставе ў Маскве'},
      {date: '1936', text: 'Шэраг жылых дамоў на праспекце Міру ў Маскве «Дома з аркай» ў Яраслаўлі, у тым ліку дом на Чырвонай плошчы'},
