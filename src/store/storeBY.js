const architects = [
...

  {
    ...
    "bio": [
      ...
      {
        date: '1930',
        text: 'Сям’я пераехала ў Маскву, дзе Любоў пасля заканчэння школы паступіла ў Маскоўскі архітэктурны інстытут.'
      },
      {date: '1941-1945', text: 'У час Вялікай Айчыннай вайны знаходзілася ў эвакуацыі ў Ташкенце.'},
      {
        date: '1947',
        text: 'Абараніла ў 1947 з адрозненнем дыпломны праект, пасля чаго была размеркавана на працу ў Мінск ў архітэктурна-планіровачную майстэрню пры Мінгарвыканкаме, дзе таксама працаваў яе муж Васіль Іосіфавіч Герашчанка.'
      },
