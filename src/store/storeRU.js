...
const developers = [
  {
    ...
    contribution: '➤Создал базовую структуру проекта.\n ➤Реализовал переход между страницами с помощью react router.\n ➤Реализовал перевод сайта на три языка (текст писала вся команда).',
  },
  {
    id: 'D2',
    ...
    contribution: '➤Создал компонент со страницей архитектора, используя Material UI.\n ➤Добавил компонент TimeLine и компонент Map.\n ➤Перевел страницы двух архитекторов на белорусский и английский.',
  },
  {
    id: 'D3',
    ...
    contribution: '\n' +
      ' ➤Компонент страницы разработчиков. Плюс структурирование и стилизация страницы с использованием Material UI.\n' +
      ' ➤Компонент галереи с фотографиями на страницах архитекторов.\n' +
      ' ➤Контент на странице архитектора Усовой Л.Д. с переводом.\n' +
      ' ➤Контент и изображение на главной странице.',
  },
  {
    id: 'D4',
    name: 'Артур Рубченко',
    ...
    contribution: '➤Создал два компонента: меню сайта и архитектор дня.\n ➤Архитектор дня выбираеться по дате рождения, поэтому этот блок будет постоянно изменяться на того, у кого день рождения уже наступил и у кого эта дата ближайшая к текущей дате.\n ➤Меню сделано адаптивным и было реалиованно при помощи Material-UI.',
  },
  {
    id: 'D5',
    ...
    contribution: '➤Создал два компонента в которых используется Material UI: таблица проектов на странице архитектора и модальное окно показа видео с YouTube.\n ➤Оба компонента адаптивны. Для таблицы в адаптиве появляется горизонтальный скролл.\n ➤Провел работу по стилистики всего сайта.',
  },
  {
    id: 'D6',
    name: 'Павел Хомич',
    ...
    contribution: '➤Создал компонент футер сайта с показом информации о разработчиках.\n ➤Реализация компонента поиска на станице архитекоров с выдачей результатов. Компоненты выполнены с использованием Material UI.\n ➤Базовая SEO оптимизация.',
  }
];

const portalDescription= {
  title: 'Архитекторы Беларуси',
  description: '<p>Архитектура страны — это своего рода имидж государства, она может раскрывать историческое наследие, говорить о вкусах, предпочтениях и уровне жизни государства.</p>' +
    '<p>Архитектура Беларуси является истинным свидетельством ее богатой истории. Памятники истории, архитектурные сооружения связаны со средневековым, восточно-европейским и русским искусством. Они впитали в себя национальные и европейские тенденции развития архитектуры. Замки Беларуси – это уникальные шедевры.</p>' +
    '<p>Многие постройки на территории страны выполнены в византийско-балканском стиле, что делает их более выраженными на фоне современных сооружений. Монументальные памятники в стиле барокко, дворцы в Гродно, Могилеве отличаются утонченностью и изысканностью. Дворцовые ансамбли в Гомеле относятся к памятникам классицизма.</p>' +
    '<p>Архитектура Беларуси связана с ее историческими событиями, переплетением художественных стилей. Многообразие стилей делает страну еще более яркой и живописной.</p>' +
